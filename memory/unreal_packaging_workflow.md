...
`RunUAT.bat BuildCookRun -project="D:\O\Odilbek.uproject" -noP4 -platform=Win64 -clientconfig=Development -build -cook -stage -pak -archive -archivedirectory="E:\MIR MIRON PACKAGE" -utf8output -nocompileeditor`
