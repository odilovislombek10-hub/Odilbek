...
**Fakt 4 — unused-asset tozalash (2026-07-03).** 8 ta package-level (Glavniy_MirMIron, Pragulka, VR, MirMiron/Interior52_40PR+VR, Interior69_52PR+Vr, Padez_Pragulka) ning to'liq rekursiv dependency to'plami = 2754 /Game asset (exists()-guarded BFS, 5493 ops, completed). 1777 teksturadan 915 ishlatiladi, 862 (5.66GB) ishlatilmaydi. To'liq (0 keep) ishlatilmagan stok paketlar O'CHIRILDI: PosedHumansPack1 (2.72GB), PosedHumansShoppingPack1 (0.31GB), FPWeapon (0.03GB), StarterContent (0.59GB, audio uchun 2-marta delete kerak bo'ldi) = ~3.65GB. Characters O'CHIRILMADI (122 asset ishlatiladi). Qolgan ~2.3GB unused tekstura qisman-ishlatilgan paketlarda (ArchVizExplorer 0.48, AutomotiveMaterials 0.40, Megascans 0.30, Level/Galereya 0.22, TwinEra 0.16, Mavrid, UDS) — SOFT-REFERENCE xavfi (get_dependencies faqat hard-dep) tufayli avtomatik o'chirilmadi, foydalanuvchi ko'rib chiqishi kerak. MUHIM: bu disk/package hajmini kamaytiradi, bitta ochiq levelning jonli VRAM'iga ta'sir qilmaydi (ishlatilmagan asset baribir yuklanmagan edi). exists() safe (false qaytaradi, abort qilmaydi); delete folder ishlaydi va 0-referencerda redirector qoldirmaydi.\n\nMCP cheklovi: konsol buyrug'i (stat rhi/memreport/listtextures) MCP orqali yo'q; get_dependencies stale/redirector ссылкага urilsa BUTUN skriptni to'xtatadi (try/except ushlamaydi) — rekursiya o'rniga get_referencers/disk-scan ishlatildi. Bog'liq: [[unreal_cesium_3dtiles_weight]], [[unreal_perf_texture_audit]].
