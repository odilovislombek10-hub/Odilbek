...
public:
	 ...
	 */
	UFUNCTION(BlueprintPure, Category = "easyCSV|Post-Parse Operations", meta = (Keywords = "headers, cells, columns"))
	 ...
	 */
	UFUNCTION(BlueprintPure, Category = "easyCSV|Post-Parse Operations", meta = (Keywords = "keys, cells, rows"))
	 ...
	 */
	UFUNCTION(BlueprintPure, Category = "easyCSV|Post-Parse Operations", meta = (Keywords = "cells, keys, headers, columns"))
	 ...
	 * @param CSV_Info A structure containing parsed CSV data. Can be created using MakeCSV_InfoFromString.
	 */
	UFUNCTION(BlueprintPure, Category = "easyCSV|Post-Parse Operations", meta = (Keywords = "rows"))
	 ...
	 * @param CSV_Info A structure containing parsed CSV data. Can be created using MakeCSV_InfoFromString.
	 */
	UFUNCTION(BlueprintPure, Category = "easyCSV|Post-Parse Operations", meta = (Keywords = "columns"))
	 ...
	 */
	UFUNCTION(BlueprintPure, Category = "easyCSV|Post-Parse Operations", meta = (Keywords = "rows, keys"))
	 ...
	 * @param CSV_Info A structure containing parsed CSV data. Can be created using MakeCSV_InfoFromString.
	 */
	UFUNCTION(BlueprintPure, Category = "easyCSV|Post-Parse Operations", meta = (Keywords = "keys, rows"))
	 ...
	 * @param CSV_Info A structure containing parsed CSV data. Can be created using MakeCSV_InfoFromString.
	 */
	UFUNCTION(BlueprintPure, Category = "easyCSV|Post-Parse Operations", meta = (Keywords = "headers, columns"))
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "easyCSV|Main", meta = (Keywords = "parse", DisplayName = "Make CSV Info From String", ScriptName = "MakeCsvInfoStructFromString"))
	 ...
	 * @param ParseKeys If true, the parser will expect the first column of the CSV to be row labels, or keys. If false, values will be generated.
	 */
	UFUNCTION(BlueprintCallable, Category = "easyCSV|Main", meta = (Keywords = "parse", DisplayName = "Make CSV Info From File", ScriptName = "MakeCsvInfoStructFromFile"))
