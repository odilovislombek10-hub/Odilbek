...
public:
	...
	*/
	 ...
	 */
	UFUNCTION(BlueprintPure, Category = "Runtime DataTable", meta = (DefaultToSelf = "Object", AdvancedDisplay = "IncludeInheritedVariables, MemberBlacklist", DeprecatedFunction, DeprecationMessage="This function has been deprecated, Please use GetAllObjectPropertyNames"))
	...
	{
        return GetAllObjectPropertyNames(Object, bIncludeOnlyConfigVariables, bIncludeInheritedVariables, MemberBlacklist);
	}
 ...
 */
	UFUNCTION(BlueprintPure, Category = "Runtime DataTable", meta = (DefaultToSelf = "Object", AdvancedDisplay = "IncludeInheritedVariables, MemberDenylist"))
	static FString GetAllObjectPropertyNames(
		const UObject* Object, 
		const bool bIncludeOnlyConfigVariables = false, const bool bIncludeInheritedVariables = false,
		FString MemberDenylist = "UberGraphFrame, DefaultSceneRoot");
...
protected:
	 ...
	 * @param InMemberAllowlist Names of variables in your structs or objects that you want to include in the output string. 
	*/
