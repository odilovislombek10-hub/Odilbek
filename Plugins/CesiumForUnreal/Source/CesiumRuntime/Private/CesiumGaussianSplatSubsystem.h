...
private:
  ...
  TWeakObjectPtr<UNiagaraComponent> _pNiagaraComponent = nullptr;
  TWeakObjectPtr<ACesiumGaussianSplatActor> _pNiagaraActor = nullptr;
  TWeakObjectPtr<UWorld> _pLastCreatedWorld = nullptr;
